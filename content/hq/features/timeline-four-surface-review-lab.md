---
id: timeline-four-surface-review-lab
title: Signal Timeline four-surface review lab
...
The review lab uses synthetic, in-memory fixtures and session-only interactions. The Vercel Preview is protected by Vercel Authentication and the route fails closed on Vercel Production.

- Review entry: [Open Option B owner plan](https://roadmap-m7f3csrq3-ethanmcn2013-1730s-projects.vercel.app/__design-lab/timeline?option=b&surface=owner&dataset=wedding&density=normal&state=default&viewport=responsive&preview=working)
- Deployment inspector: [Vercel deployment](https://vercel.com/ethanmcn2013-1730s-projects/roadmap/3W6krhr15HicXNWQ5bSkNDxMDFyH)
...
| Direction | Consensus score | Strongest use | Main tradeoff |
| --- | ---: | --- | --- |
| A — Quiet Direction Ledger | 9.78 | Fast daily owner curation | Least expressive change narrative |
...
- 18 model, query, and route-guard checks passed.
- 52 browser checks passed across all option and surface combinations.
