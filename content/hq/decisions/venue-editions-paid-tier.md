...
Full plan + math + scenarios + the AI agent-factory operating model at docs/MARKETING_PLAN_6MO.md. Pricing surface code (signalstudio.ie/pricing) and VENUE_EDITIONS_PLAN.md still describe the free-compliments model — they are now drift against this decision and owed an update in the pre-launch readiness pass (not yet done as of 2026-05-16). Success is judged on five leading indicators (≥10 paid venues by M3, ≥25% close rate, ≥1 referral inbound by M4, ≥40% sponsored-couple activation, zero brand-integrity exceptions), not a vanity €500k.
