...
Keep group work visible without relying on chat memory.

## Notes

Now framed as the `final-paper-sprint` anchor template — lift the existing Tasks-only template to four-layer in Cycle T-4.
