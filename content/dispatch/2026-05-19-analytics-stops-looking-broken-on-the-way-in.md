## 2026-05-19 · ships · Signal stops looking broken on the way in

**Navigating into Signal no longer shows a naked indigo dot on
...
Signal, so the authed route blocked with zero streaming and a
