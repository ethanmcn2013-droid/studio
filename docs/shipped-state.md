...
| Event | New sales unavailable. Retained intended terms: €89 once; one event Workspace; twelve calendar months, then read-only; refund revokes access. | Project/archive/refund enforcement remains incomplete. App candidate a10432dd holds new checkout sessions; deployed sales state is unverified. Do not advertise an enforced archive or infer historical owner designation. See `content/hq/decisions/event-project-funding-2026-09-04.md`. |
