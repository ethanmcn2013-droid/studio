...
Owner: founder
Companion docs: `VENUE_EDITION_VIDEO_BRIEF.md`, `VENUE_SETUP_RITUAL.md`, `VENUE_EXAMPLE_ROADMAP.md`

---

## Purpose

This document turns the venue story into a demo system that can be captured, animated, narrated, and reused.

The demo is not a feature tour. It is one wedding moving through the suite:
...
| Element | Decision |
| --- | --- |
| Working title | One wedding Tuesday |
| Couple | Aoife & Ciaran |
| Venue | Glenmara House |
| Wedding date | 12 September 2027 |
| Core tension | The couple is trying to close final numbers, supplier access, music/sound, and the final walkthrough. |
| Repeated venue question | "When can suppliers arrive, and when do you need final numbers?" |
| Proof sentence | This is the email the venue stops having to send. |

---

## Demo Data

Use this exact content across product surfaces unless a real venue/couple pilot replaces it.

| Object | Content |
| --- | --- |
| Venue eyebrow | Planning with Glenmara House |
...
Aoife and Ciaran need final guest numbers by 1 June so Glenmara can lock catering.

Supplier access:
- florist can arrive from 8am
- band can arrive from 2pm
- photographer can arrive with the couple from 11am

Still open:
- ceremony music list
- final table count
- whether the florist needs a second walkthrough after the tasting
```
...
| Task | Owner | State |
| --- | --- | --- |
| Send final guest number to Glenmara | Aoife | Waiting on couple |
| Confirm florist access window | Venue | Done |
| Send ceremony music list | Ciaran | This week |
| Book final walkthrough | Venue | Scheduled |
...
| --- | --- | --- | --- |
| Now | Final numbers | Waiting on you | Glenmara needs final guest count by 1 June to lock catering. |
| Now | Arrival and access times | Done | Suppliers have their arrival windows. No more back-and-forth needed. |
| Soon | Music and sound | Waiting on you | Send the ceremony list and band load-in time two weeks out. |
| Soon | Florist walkthrough | Coming up | Set after the menu tasting if the table plan changes. |
...
1. Final guest count is the only item blocking catering.
2. Band load-in time has not been confirmed.
3. Final walkthrough is booked. No venue action needed today.
```
...
Use this for the main venue proof cut.

| Time | Visual | Voiceover | On-screen text |
| --- | --- | --- | --- |
| 0-6s | Empty venue space or simple text card. | "A couple books your venue. Everyone is warm." | One wedding Tuesday |
...
Use the same visuals and hold these text cards:

1. A couple books your venue.
...
Use this as the narrated walkthrough on `/venues/demo`, founder Loom, or sales-call share.

| Time | Visual | Voiceover |
| --- | --- | --- |
| 0-10s | Venue page or opening card. | "This is the Venue Edition in one wedding Tuesday. The venue is Glenmara House. The couple is Aoife and Ciaran. They are planning a September wedding." |
...
| Asset | Required shot | Acceptance |
| --- | --- | --- |
| Venue establishing shot | Empty premium space or restrained abstract tabletop. | Feels calm and physical, not stock-wedding romantic. |
...
When presenting live to a venue:
...
| Gate | Pass condition |
| --- | --- |
| One story | It feels like one wedding, not four products. |
| Venue buyer clarity | The venue understands what it pays for. |
| Couple experience | The couple's plan feels useful without explanation. |
| Motion restraint | Movement clarifies state; it does not decorate. |
| No fake claims | No usage numbers, no "trusted by," no invented case study. |
| No hard CTA pressure | The demo earns conversation; it does not shout for it. |
