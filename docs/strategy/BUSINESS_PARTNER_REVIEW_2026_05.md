...
**Signal Studio helps non-technical people coordinate important work without making everyone learn project-management software.**

The category is not productivity. It is coordination clarity for the 80% who don't work in tech — wedding planners, venue coordinators, freelancers, tradespeople, students, small-shop owners, teachers.

What that sentence refuses to be:

- Not generic productivity software. Productivity tools add surface. We remove it.
- Not wedding software. Weddings are the first room we walked into, not the house.
- Not a dashboard company. The output is a calmer week, not a chart.

The line a generic competitor would never write: *We measure ourselves by how little of our software you have to think about.*

### The two-wedge distinction (read this before anything else)
...
Premium venues are the first proof case. Not because weddings are the market — because a premium venue is a buyer who (a) has real money, (b) feels the pain weekly, (c) can say yes alone, and (d) hands us a cohort of couples with one decision. One signature, a cohort of activated users. That is the wedge.

**Why premium specifically:** a premium venue sells a feeling of being looked after. Confused couples and repetitive admin erode exactly the thing they charge for. The product protects their brand promise, not just their inbox. A budget venue does not have that incentive; do not chase down-market to fill a pipeline.

**Core venue promise:**
> Fewer confused couples. Fewer repetitive emails. A better planning experience under your venue's name.

The venue pays once a year. The couple never sees a price. The venue's name sits in a quiet line at the top of the couple's workspace — an eyebrow, not a logo wall. Nothing for the venue's team to run.

---

## 4. Venue Edition thesis

**Thesis:** A premium venue will pay €1,500–€4,000 a year, prepaid, for an instrument that reduces coordination chaos for the couples it has already booked — *if* the experience is calm, branded quietly, and zero-admin on their side. The product is patronage, not a tool the venue operates. The venue's only verbs are: settle the year, hand out codes, do one short retro.

**What we are actually testing (the only thing that matters in the next 30 days):** not "do venues like the demo" — *does a venue owner move real money before the product is finished.* Interest is not proof. A signed prepaid invoice is proof. Everything in the 30-day plan exists to reach that one event.

**Why it can fail (held honestly):** the venue may like it and not pay, because the pain — though real — is diffuse across their team rather than owned by the person who can sign. If the buyer and the sufferer are different people, the sale stalls. The pilot is designed to surface that fast and cheap.

Pricing, objections, qualification, success metrics, and kill triggers for the venue motion are specified in `docs/strategy/VENUE_EDITION_STRATEGY.md`. This doc owns the thesis; that doc owns the operating detail.
...
Anything not in service of these five is out of scope for 30 days, including suite polish, new products, and additional audience landing pages.

---

## 6. The five metrics

Only these. Everything else is noise this cycle.

1. **Qualified replies** — a real venue decision-maker engaging, not a thanks-not-now.
...
## 8. Kill / pivot triggers

Pre-committed, so the decision is made now while it is cheap, not later while it is emotional.

- **Kill the venue wedge** if, after 20 founder-signed outreaches and the calls they produce, **zero venues sign a paid pilot within 60 days** and the stated reason is consistently "not worth paying for" rather than timing or fit. That is the market saying no to the thesis, not to the execution.
- **Pivot the buyer** (not kill) if venues engage warmly but cannot sign because the sufferer isn't the buyer — move the wedge to wedding planners or coordinators who own their own P&L.
- **Pivot off weddings entirely** if the same pitch lands faster with a different premium coordinator (events, hospitality, clinics) in unsolicited inbound. Follow the pull.
- **Stop, do not pivot,** if pilots sign but couples don't activate (metric 4 flat). That means the product, not the wedge, is the problem — fix the product before spending more outreach.

No trigger fires on vanity metrics. Only on the five.

---

## 9. Video brief summary
...
6. Add the business-strategy mission-control section to Signal HQ (North Star, wedge, hierarchy, 30-day focus, five metrics, risks, kill triggers, next decisions). [this cycle]
7. Founder: finalise the 20-venue outreach list from the existing prospect CRM and send signed, one at a time. [founder, post-cycle]
8. Founder: settle the first paid pilot. Everything above is in service of this. [founder]

---

*The discipline is the product. If a surface downstream of this doc reads like generic SaaS, it is wrong, regardless of what it says.*
