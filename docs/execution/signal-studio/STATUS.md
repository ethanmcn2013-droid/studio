...
- **NEW FOUNDER DIRECTIVE (session close): proceed through ALL phases without permission stops; NOTHING deploys/merges to main; finish with FINAL_REPORT.md.** See SESSION_HANDOFF.md for the full continuation plan (next: production port of the task-detail lab).
