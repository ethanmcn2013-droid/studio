...
- Context-action system (D-005): builder IN FLIGHT — Radix dropdown+context menus wrapped in one ContextActions primitive, single registry drives right-click + visible •••, consolidating the existing card menu.
