...
| 2 | ✅ nudge rate-limit/mute/guards + 8-test invite-lifecycle runtime suite + security-regression additions, all green | ◐ sections follow existing settings/panel grammar; full pass at Phase 3 | ◐ settings tab strip covers mobile per existing pattern | ◐ keyboard-reachable rows/buttons via existing primitives; full audit Phase 3 | ✅ Opus review pre-implementation + all blockers remediated (D-018/019/020); revoke has server-side ownership check | ◐ one extra Clerk round-trip on settings load (parallelised) | ✅ additive 0018+0019 w/ receipts, db:contract green | ⏸ CI on PR; KNOWN QA ITEMS: live-Clerk session list/revoke needs manual verify once providers enabled; provider string matching vs Clerk ids; Clerk-failure degrade shows "No active sessions" |
| 3 | — | — | — | — | — | — | — | — |
| 4 | — | — | — | — | — | — | — | — |
| 5 | — | — | — | — | — | — | — | — |
| 6 | — | — | — | — | — | — | — | — |
