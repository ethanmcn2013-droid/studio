...
This preserves the former active entry. Current truth lives at content/atlas/pricing-and-entitlements.md. Do not use this snapshot as current product, payment or deployment evidence.
