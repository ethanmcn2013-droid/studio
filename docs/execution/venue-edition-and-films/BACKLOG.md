# BACKLOG — Venue Edition and Films (VEF-2026)
...
State as at 2026-08-03T02:33:41.907Z · baseline **approved** (0.1.0)
...
Board fields, per E01.05: epic (section heading) · task ID · priority · status · owner (executor) · dependency · acceptance evidence · target date.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| E01.01 | Publish a one-page source-of-truth brief containing the current offer, product model, geography, films and superseded assumptions. | done | p0 | CP SN | claude_code | — | — | 9 | — | ✓ | approved |
| E01.02 | Define the primary project objective as 25 signed and paid founding venues, rather than 25 invitations or expressions of interest. | done | p0 | CP SN | claude_code | — | — | 6 | — | ✓ | approved |
| E01.03 | Separate the 1 September release milestone from the final project-closure milestone of 25 paid and onboarded venues. | done | p0 | CP SN | claude_code | — | — | 6 | — | ✓ | approved |
| E01.04 | Lock project scope and explicitly exclude internal venue operations, full-scale schools, full-scale students and unrelated product expansion. | done | p0 | CP SN FD | claude_code | — | — | 6 | — | ✓ | approved |
| E01.05 | Create the project board with fields for epic, task ID, priority, status, owner, dependency, acceptance evidence and target date. | done | p0 | CP SN | claude_code | — | — | 6 | — | ✓ | approved |
| E01.06 | Assign an accountable owner or lead agent to every epic while retaining founder approval over product, commercial and release decisions. | done | p0 | CP SN FD | claude_code | — | — | 6 | — | ✓ | approved |
| E01.07 | Build the complete dependency map and identify the product, legal, capture, film and outreach critical paths. | done | p0 | CP SN | claude_code | — | — | 6 | — | ✓ | approved |
| E01.08 | Create a decision log recording every ratified commercial, legal, product, design and film decision. | done | p0 | CP SN | claude_code | — | — | 6 | — | ✓ | approved |
| E01.09 | Create a project risk and issue register covering commercial, product, privacy, delivery, founder-capacity and launch risks. | done | p0 | CP SN | claude_code | — | — | 7 | — | ✓ | approved |
| E01.10 | Define six formal release gates: commercial, legal, product, data, creative and sales-readiness. | done | p0 | CP SN FC | claude_code | — | — | 10 | — | ✓ | approved |
| E01.11 | Set the offer-freeze, UI-freeze, copy-freeze, capture-freeze, film-lock and release-candidate dates. | done | p0 | CP SN FD | claude_code | — | — | 6 | — | ✓ | approved |
| E01.12 | Establish a weekly operating review covering blockers, decisions, evidence, quality, pipeline and the next seven days. | done | p1 | SN FD | claude_code | — | — | 7 | — | ✓ | approved |
...
| E04.09 | Define wedding-date metadata, event-date changes and which dates can appear in the Venue Portal. | done | p1 | CP FD | claude_code | E03.08 | — | 6 | — | ✓ | approved |
| E04.10 | Lock the black-rail rule for authenticated owner experiences and the rail-free rule for shared public artifacts. | done | p1 | CP | claude_code | — | — | 2 | — | ✓ | approved |
| E04.11 | Document all lifecycle edge cases and expected product behaviour before implementation. | done | p2 | — | claude_code | — | — | 3 | — | ✓ | approved |
| E04.12 | Build deterministic migration fixtures and test data for every lifecycle state. | done | p2 | — | claude_code | E04.07 | — | 5 | — | ✓ | approved |
...
Lane: `claude_code` · 0/12 done (0%) · 0 in flight · 0 blocked

| ID | Title | Status | Pri | Flags | Executor | Depends on | Target | Evidence | Blocker | Spec | Sign-off |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E05.01 | Map the complete couple journey from venue invitation through first useful action, active planning, wedding day and Keepsake mode. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
...
| E05.03 | Build the default wedding workspace template with restrained milestones, decisions, tasks and example Notes. | backlog | p1 | CP RB FC | claude_code | — | — | — | — | — | not_requested |
| E05.04 | Complete the wedding-specific Notes experience, including voice capture, manual capture and high-signal structured output. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E05.05 | Complete the Notes-to-Tasks promotion flow using ordinary wedding-planning language. | backlog | p1 | CP RB | claude_code | E05.04 | — | — | — | — | not_requested |
| E05.06 | Complete the wedding Tasks experience for ownership, due dates, status, tags, priorities and clear next actions. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E05.07 | Complete the task-detail experience for comments, attachments, subtasks, decisions and private collaboration. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E05.08 | Complete the authenticated Timeline planning experience and its relationship with tasks and milestones. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E05.09 | Complete the wedding-specific Signal briefing showing only what needs the couple’s attention today. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E05.10 | Complete spouse, planner, family-member and collaborator invitations with appropriate role boundaries. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
...
Lane: `claude_code` · 0/18 done (0%) · 0 in flight · 0 blocked

| ID | Title | Status | Pri | Flags | Executor | Depends on | Target | Evidence | Blocker | Spec | Sign-off |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E07.01 | Lock the portal information architecture and the primary buyer job of administering and proving the sponsored benefit. | backlog | p1 | CP RB FC | claude_code | — | — | — | — | — | not_requested |
| E07.02 | Redesign Overview so “Invite a couple” is the principal action. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.03 | Complete account-standing, current-term, founding-status, renewal-date and support-status presentation. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.04 | Ratify every adoption-funnel definition from invitation through meaningful first action and continued use. | backlog | p1 | CP RB FD | claude_code | E09.02 | — | — | — | — | not_requested |
| E07.05 | Implement an evidence-backed next-action system for stale invitations, low redemption, incomplete setup and renewal preparation. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.06 | Replace product-centric metrics with understandable customer outcomes while retaining detailed product reach where useful. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.07 | Replace the old 40/80 allotment language with the final eligible-booking or fair-use entitlement model. | backlog | p1 | CP RB FD | claude_code | E02.12 | — | — | — | — | not_requested |
| E07.08 | Complete invitation creation, copying, sending, resending, revoking, replacing, expiring and redemption status. | backlog | p1 | CP RB | claude_code | E02.12 | — | — | — | — | not_requested |
| E07.09 | Complete access search, filters, pagination, stale-invitation alerts and masked-code handling. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.10 | Complete the distribution kit with approved email wording, welcome link and printable welcome card. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.11 | Complete Usage with first useful action, recent use, continued use, product reach and measurement definitions. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.12 | Implement the ratified small-cohort suppression rule and the “Use, without surveillance” privacy receipt. | ready | p1 | CP RB FD | claude_code | — | — | — | — | — | not_requested |
| E07.13 | Refine lifecycle visualisation and ensure it does not imply surveillance or expose private behavioural detail. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.14 | Complete monthly, access-term and renewal-report generation. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.15 | Complete reconciled PDF and CSV exports with data-through dates, completeness states and definition versions. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.16 | Complete Account, organisation settings, members, roles, support history and reporting preferences. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.17 | Add the live branded couple-experience preview, branding controls and appropriate upcoming wedding-date view. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E07.18 | Complete portal permissions, audit history, empty/loading/error states, responsive design, accessibility and end-to-end data reconciliation. | backlog | p1 | CP RB | claude_code | E07.01, E07.02, E07.03, E07.04, E07.05, E07.06, E07.07, E07.08, E07.09, E07.10, E07.11, E07.12, E07.13, E07.14, E07.15, E07.16, E07.17 | 2026-08-20 | — | — | — | not_requested |
...
| ID | Title | Status | Pri | Flags | Executor | Depends on | Target | Evidence | Blocker | Spec | Sign-off |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E08.01 | Implement annual prepaid billing for standard and founding agreements. | backlog | p1 | CP RB | claude_code | E03.08 | — | — | — | — | not_requested |
| E08.02 | Implement an immutable founding-rate flag and historical price record for each qualifying venue. | backlog | p1 | CP RB | claude_code | E02.03 | — | — | — | — | not_requested |
| E08.03 | Implement renewal invoices, renewal reminders, failed-payment handling, grace periods and lapse behaviour. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.04 | Complete multi-tenant data isolation and database row-level security for venues and couple workspaces. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.05 | Complete role-based authentication and authorisation across venue owners, managers, viewers and couples. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.06 | Secure invitation tokens against guessing, reuse, unintended forwarding, replay and duplicate redemption. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.07 | Secure photograph and attachment uploads with file validation, malware controls, size limits and private storage. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.08 | Complete audit logging, operational logging, error monitoring and alert escalation. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.09 | Complete backups, restore testing, disaster-recovery procedures and data-integrity verification. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.10 | Set and test performance budgets across portal, couple workspace, Timeline images and public artifact. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.11 | Complete unit, integration, end-to-end, browser, responsive and device test coverage for the entire sponsored journey. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |
| E08.12 | Complete security review, production-readiness review, release checklist, rollback process and incident-response runbook. | backlog | p1 | CP RB | claude_code | — | — | — | — | — | not_requested |

## E09 — Measurement, demo data and copy system

_Blocks trustworthy portal reports, product capture and final scripts._

Lane: `claude_code` · 4/12 done (33.3%) · 0 in flight · 0 blocked
...
| E09.03 | Instrument invitation, activation, meaningful-use, public-sharing and Keepsake transitions. | backlog | p1 | CP | claude_code | — | — | — | — | — | not_requested |
| E09.04 | Instrument personalised-film views, landing-page visits, booking actions, meetings, proposals and paid conversion. | backlog | p1 | CP | claude_code | — | — | — | — | — | not_requested |
| E09.05 | Join CRM, commercial, product and reporting data into one founder operating dashboard. | backlog | p1 | CP | claude_code | — | — | — | — | — | not_requested |
| E09.06 | Lock the canonical demo story for the venue, couple and wedding journey. | done | p1 | CP FD | claude_code | — | — | 1 | — | — | approved |
| E09.07 | Build a deterministic Glenmara House and Mara-and-Finn demonstration fixture across all four products and the portal. | backlog | p1 | CP | claude_code | — | — | — | — | — | not_requested |
| E09.08 | Source and license all demonstration photographs and confirm that no unapproved real venue or couple material is used. | ready | p1 | CP FD | claude_code | — | — | — | — | — | not_requested |
| E09.09 | Reconcile every sample invitation count, adoption metric, report number, date and product-reach value. | backlog | p1 | CP | claude_code | E09.06, E09.07 | — | — | — | — | not_requested |
| E09.10 | Publish the Venue Edition copy hierarchy, terminology and tone rules. | done | p1 | CP FC | claude_code | — | — | 1 | — | — | approved |
| E09.11 | Finalise offer, founding-rate, privacy, collaboration, Keepsake, CTA, objection and FAQ copy. | backlog | p1 | CP | claude_code | E09.10 | — | — | — | — | not_requested |
| E09.12 | Freeze the capture copy and build a one-action demo reset that restores the canonical state. | backlog | p1 | CP | claude_code | E02.01, E02.03, E02.12, E03.09, E09.11 | 2026-08-21 | — | — | — | not_requested |
...
Lane: `founder` · 13/14 done (92.9%) · 0 in flight · 0 blocked
...
| E11.08 | Build the booking flow and meeting-confirmation sequence. | done | p2 | — | claude_code | — | — | 1 | — | — | approved |
| E11.09 | Write the discovery-call structure and qualification questions. | done | p2 | — | claude_code | — | — | 1 | — | — | approved |
| E11.10 | Write the live product walkthrough and demonstration sequence. | done | p2 | — | claude_code | — | — | 1 | — | — | approved |
| E11.11 | Write the post-demo proposal, commercial summary, order form and same-day follow-up. | done | p2 | — | claude_code | — | — | 1 | — | — | approved |
| E11.12 | Build the objection library covering price, adoption, privacy, support, existing tools, implementation and product maturity. | done | p2 | — | claude_code | — | — | 1 | — | — | approved |
| E11.13 | Define the follow-up sequence, no-response sequence and respectful stopping rule. | done | p2 | FD | claude_code | — | — | 1 | — | — | approved |
| E11.14 | Define founding-slot holds, proposal expiry, payment-to-lock procedure, close-lost reasons, referral asks and publicity consent. | done | p2 | FD | claude_code | — | — | 1 | — | — | approved |
| E11.15 | Run a weekly conversion review covering cohort, channel, meeting quality, objections, proposals, wins and next-cohort changes. | done | p2 | — | founder | — | — | 1 | — | — | approved |
...
| E12.08 | Add the complete commercial, product, support, entitlement, Keepsake and renewal FAQ. | backlog | p2 | — | claude_code | E02.12 | — | — | — | — | not_requested |
| E12.09 | Produce the concise one-page commercial proposal. | backlog | p2 | — | claude_code | — | — | — | — | — | not_requested |
...
| E12.14 | Complete analytics, conversion, responsive, accessibility, performance, copy and visual QA across every commercial page. | backlog | p1 | CP | claude_code | E12.04, E12.05, E12.06 | — | — | — | — | not_requested |
...
Lane: `codex_motion` · 0/18 done (0%) · 0 in flight · 0 blocked
...
| E13.03 | Build the stylised Greater Limerick map geometry, River Shannon path and 15-, 30- and 45-minute rings. | backlog | p1 | SN | codex_motion | — | — | — | — | — | not_requested |
| E13.04 | Build the data-driven map composition using verified venue coordinates and cohort metadata. | backlog | p2 | — | claude_code | — | — | — | — | — | not_requested |
...
| E13.08 | Build the €1,500-to-€1,000 price animation and test “€500 less,” “one-third less” and “33.3%” presentation. | backlog | p2 | — | codex_motion | E02.01, E02.02 | — | — | — | — | not_requested |
| E13.09 | Finalise legally safe founding-rate-lock language for voiceover and on-screen presentation. | backlog | p2 | FD | codex_motion | E02.03 | — | — | — | — | not_requested |
| E13.10 | Produce the complete storyboard and frame-level motion plan. | backlog | p1 | SN | codex_motion | E13.07 | — | — | — | — | not_requested |
| E13.11 | Produce an animatic with temporary voiceover and sound. | backlog | p2 | — | codex_motion | E13.10 | — | — | — | — | not_requested |
...
| E13.15 | Build the parameterised rendering pipeline using venue name, coordinates, cohort and private CTA data. | backlog | p2 | — | claude_code | — | — | — | — | — | not_requested |
| E13.16 | Generate unique tracked links, thumbnails and landing destinations for every personalised render. | backlog | p2 | — | claude_code | — | — | — | — | — | not_requested |
...
Lane: `codex_motion` · 1/18 done (5.6%) · 0 in flight · 0 blocked

| ID | Title | Status | Pri | Flags | Executor | Depends on | Target | Evidence | Blocker | Spec | Sign-off |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E14.01 | Write the formal creative brief for the 60–75 second Venue Edition film. | backlog | p1 | SN | codex_motion | — | — | — | — | — | not_requested |
| E14.02 | Finalise the narrative arc from fragmented planning to one calm sponsored experience. | backlog | p1 | SN | codex_motion | — | — | — | — | — | not_requested |
| E14.03 | Design the opening sequence of messages, email, phone notes, journals and disconnected decisions. | backlog | p1 | SN | codex_motion | — | — | — | — | — | not_requested |
| E14.04 | Lock the central insight: the wedding happens at the venue, but the couple’s experience begins months beforehand. | backlog | p1 | SN | codex_motion | — | — | — | — | — | not_requested |
| E14.05 | Select one wedding decision to travel through Notes, Tasks, Timeline and Signal. | backlog | p1 | SN FC | codex_motion | — | — | — | — | — | not_requested |
| E14.06 | Design and capture the Notes sequence. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.07 | Design and capture the Tasks sequence. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.08 | Design the Timeline hero sequence and the map-pin-to-milestone transition. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.09 | Build the “We said yes,” venue reservation, menu tasting and wedding-day photograph moments. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.10 | Design and capture the Signal daily-briefing sequence. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.11 | Show the venue-branded welcome and “Compliments of [Venue]” experience. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.12 | Show the privacy boundary and Venue Portal as the quiet trust-and-renewal layer. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.13 | Decide the exact placement of the standard price, founding rate and final walkthrough CTA. | done | p2 | FD | codex_motion | — | — | 1 | — | — | approved |
| E14.14 | Produce the complete storyboard and approved animatic. | backlog | p2 | — | codex_motion | — | — | — | — | — | not_requested |
| E14.15 | Produce the product-capture plan and record only after the UI, copy and demo environment are frozen. | backlog | p1 | CP | codex_motion | E05.12, E06.12, E07.18, E09.09, E09.12 | 2026-08-22 | — | — | — | not_requested |
| E14.16 | Complete voiceover, music, sound design, compositing, pacing and final edit. | backlog | p2 | — | codex_motion | E14.15 | — | — | — | — | not_requested |
| E14.17 | Produce the 16:9 master, captions, transcript and approved 9:16 and 1:1 cutdowns. | backlog | p2 | — | codex_motion | E14.16 | — | — | — | — | not_requested |
| E14.18 | Complete final brand, product-accuracy, privacy, audio, caption, encoding and archive QA. | backlog | p1 | CP | codex_motion | E14.17 | 2026-08-28 | — | — | — | not_requested |
