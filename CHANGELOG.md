...
## 2026-07-28 · S·149 · ships · the Handoff enters the review room
...
sequence. The live pages and their heroes are unchanged while three
deterministic directions sit side by side for review.
...
## 2026-07-25 · S·135 · tightens · the public wedding link stays put
...
## 2026-07-25 · S·133 · tightens · one front door, one app, four clear products
...
The naming constitution, machine contract, navigation helpers, sitemap, and retirement rules now carry the same map. Homepage rows stay in the current tab, product wordmarks no longer point at temporary hash anchors, and the opening sentence names the four products in their current order.
...
## 2026-07-16 · S·129 · holds · Signal gets depth without losing the briefing

**Signal's next read path is now explicit across the product contract and HQ: the first screen still shows zero to three things that need attention, then Overview, Trends, and Evidence answer the next question without asking the reader to build a dashboard.** Overview arrives composed. Trends takes one metric at a time and says when history is too thin. Evidence names the deterministic rule, comparison, coverage, and permitted source records behind the claim. Customization stops at hide, pin, reorder, and restore.
...
## 2026-07-15 · S·127 · tightens · Slide 30 becomes the proof mark
...
## 2026-07-02 · S·97 · ships · three more review rooms — the partner card, the cafÃ© card, the poster
...
plainly: all four products on every plan, two deliveries that come to
...
(Â§11.01.6) — the lone motion is the cover dot settling once, removed
...
(S·U1 title â†’ S·U2 pricing â†’ S·U3 /about). The catch-net only works
...
"Everything important. Nothing distracting." (BRAND Â§2) — sanctioned
...
link still read "Cut through the noise." — a line BRAND.md Â§6 retired
...
Tasks now presents only its four real audiences — BRAND.md Â§3's
...
migration sequence (HQ-6a/-6b/-6c.1/-6c.2/-6c.3/-6c.4 â†’ S·24) is
...
Voice for the three new parent headers follows BRAND.md Â§3 — plain
...
with both shipped instances documented — analyticsâ†’studio cron-ping
...
menu — two specific contract violations (Â§4 no views, Â§7 no
...
auditor, fintech founder Y — exactly the tech-bro register Â§2 says
...
event tables when we have â‰¥3 partners — not for one.
...
own address, written in BRAND.md Â§3 voice — no exclamation marks, one
...
empty state — open âŒ˜P with nothing typed and roadmap, notes,
...
BRAND.md grew Â§2 today — audience deep-dive and moat. The moat line
...
copy that touches them. Â§2.1–Â§2.3 locked the three reader archetypes
