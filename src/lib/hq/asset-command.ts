...
export const TAXONOMY: Asset[] = [
  ...
  { id: "press-logo-pack", name: "Logo pack + founder headshot spec", family: "D · Press kit", audience: "Press / partners", purpose: "Correct marks and a headshot brief so coverage looks right.", funnel: "Launch", revenue: "Low", proof: "Low", brandRisk: "Medium", difficulty: "Low", required: true, dependency: "brand-kit", owner: "Brand", format: "Zip + shoot brief", copy: "exists", design: "exists", score: 62, rationale: "Usage notes + kit shipped 2026-07-01 with the press shell; headshot shoot itself stays operator-gated." },
...
5 · SOURCE CONTEXT
Stay true to: the Signal Studio brand handbook (voice: declarative, plain English, no jargon, no exclamation marks; visual: white/black/indigo #4f46e5, Geist + Geist Mono, hairlines, one earned accent), the growth deck (growth.signalstudio.ie), and the real product. The three products are Notes (capture), Tasks (execution), and Timeline (direction); Home is the front door and carries Today's Signal, the daily briefing (attention). Three products, one system.
...
, signalstudio.ie
, Limerick, Ireland
, Optional single quiet line (one only, if any): Three products, one system.
...
export const OPEN_QUESTIONS: Array<{ q: string; why: string }> = [
  ...
  { q: "Venue pricing for the one-pager / pricing explainer: confirm the fixed €1,500 per venue/year price is shown everywhere.", why: "The pricing explainer and one-pager need one confirmed figure before print." },
