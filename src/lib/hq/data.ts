...
export const seedHqData: HqData = {
  ...
  products: [
    ...
    },
    {
      ...
      blockers: ["Approved Notes -> Tasks extraction endpoint and UI wiring is next (Cycle 9.4b, cross-repo into Tasks).", "First-sign-in onboarding empty state could be sharper (Cycle 9.3).", "FTS5 server-side search is a later polish — client-side filter is fast for corpora < 1000 notes."],
      notes: "Sprint 1 · Cycle 9.4b privacy polish: the live notebook now treats empty capture as a protected writing space; copy and docs state that raw notes are private by default; server actions remain user-scoped through requireUser().",
      nextActions: ["Define extract-level permissions for Notes -> Tasks.", "Sign up at notes.signalstudio.ie/sign-up; capture a note; confirm persistence across reload.", "Cycle 9.3: first-sign-in onboarding empty state."],
    },
  ],
  ecosystemFlows: [
    {
