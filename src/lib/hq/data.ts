  ...
  campaigns: [
    {
      ...
      endDate: "2026-06-30",
      currentBlocker: "Lamb's Hill seeded with 3 test codes in prod; Venue Editions infrastructure shipped end-to-end (Plan 8 Cycles 8.0–8.4.7). Soft launch (Cycle 8.5) gated on TWO operator actions before the 10-code batch can be sent to Sinéad: (1) rotate CLERK_WEBHOOK_SIGNING_SECRET in Clerk dashboard + redeploy Tasks (~5 min); (2) walk one redemption end-to-end in incognito to validate the corrected post-Clerk flow per docs/CYCLE_8_5_HANDOFF.md §Operator action #2. Parallel gates from 2026-05-12 still apply on the broader outreach side: 10-venue list by 2026-05-15, three conversations by 2026-06-02.",
