...
export const seedHqData: HqData = {
  ...
  focus: {
    ...
    focus:
      "Marketing parked. Product, brand, and web are the focus. Sprint 1 = Notes from static placeholder to a real Next.js product. Cycle 9.1 shipped today: Next.js 16 scaffold, the locked notebook surface (capture + stream + open-note + promote-to-task stub), wordmark gesture, anti-feature register, security headers. Wedding-planning demo preserved as static. Cycles 9.2 through 9.5 add DB, auth, search, and promote-to-tasks plumbing.",
    priorities: [
      "Cycle 9.2: Turso + Drizzle schema, server-action capture, cross-device sync.",
      "Cycle 9.3: Clerk auth, suite-wide account boundary, gated /app route.",
      "Cycle 9.4: FTS5 search + the cross-product promote-to-tasks endpoint.",
    ],
    risks: [
      "Sprint 1 is bounded but multi-cycle; pacing is the discipline. Don't half-start Sprint 2 before Notes is genuinely usable.",
      "Cycle 8 outreach assets stay in signal-growth/outbound — useful when marketing reopens, dead weight if rushed back into.",
      "The Analytics live briefing product (Sprint 2 candidate) is the louder credibility gap; Notes scaffold is the cleaner first win.",
    ],
    nextActions: [
      "Open Cycle 9.2 — provision Turso DB, define Drizzle schema for notes, swap localStorage for server actions.",
      "Decide suite-wide vs per-product Clerk account boundary before 9.3.",
      "Keep marketing categories at zero until Sprint 1 is operationally usable.",
    ],
  },
  products: [
    {
    ...
    },
    {
      ...
      integrationScore: 18,
      launchReadiness: 38,
      majorFeatures: ["Next.js 16 scaffold", "notebook surface (capture + stream)", "wordmark gesture", "localStorage capture", "anti-feature register", "homepage", "wedding planning demo"],
      blockers: ["No server-side persistence yet (localStorage only).", "No auth yet.", "No search yet.", "Promote-to-tasks is a UI stub."],
      notes: "Sprint 1 · Cycle 9.1 shipped Next.js scaffold and the locked notebook surface from PRODUCT.md. Sprint 1 continues across 9.2 (Turso/Drizzle), 9.3 (Clerk), 9.4 (FTS5 + promote-to-tasks).",
      nextActions: ["Cycle 9.2: server-side persistence via Turso + Drizzle.", "Cycle 9.3: Clerk auth + suite-wide account boundary.", "Cycle 9.4: FTS5 search and cross-product promote-to-tasks API."],
    },
  ],
  ecosystemFlows: [
    {
