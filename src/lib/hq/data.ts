...
export const seedHqData: HqData = {
  ...
  focus: {
    stage: "Pre-launch",
    weekOf: "2026-05-11",
    theme: "Cycle 8: make Notes private by design.",
    focus:
      "Protect Notes as the private layer while still allowing creator-approved extracts to become shared work.",
    priorities: [
      "Give the empty Notes capture field a quiet private-writing state.",
      "Document that raw notes are excluded from collaborative sharing surfaces.",
      "Use only approved extracts when Notes feeds Tasks, Roadmap, Analytics, or briefings.",
    ],
    risks: [
      "The collaboration loop could erode trust if raw notes ever appear in shared outputs.",
      "The four-product proof path is still demo-shaped until source tracking and real linked objects exist.",
      "Notes must stay emotionally private while still supporting useful action extraction.",
    ],
    nextActions: [
      "Define the extract-level permission contract for Notes -> Tasks.",
      "Write the 60-second demo script around private Notes -> approved actions -> Roadmap -> Analytics.",
      "Add source tracking for shared artefacts without exposing raw Notes content.",
    ],
  },
  products: [
    {
    ...
    },
    {
      ...
      notes: "The clearest signature format is the briefing, not a conventional dashboard. Cycle 7 adds the wedding Today Signal proof block.",
      nextActions: ["Connect risk signals to real workspace events.", "Add briefing share source tracking.", "Audit demo-vs-reality claims."],
    },
    {
      id: "notes",
      name: "Signal Notes",
      ...
      integrationScore: 26,
      launchReadiness: 31,
      majorFeatures: ["First surface", "PRODUCT.md", "private empty state", "one-way approved extraction principle"],
      blockers: ["Full v1 product work remains pending.", "Privacy boundary is documented but not yet server-enforced."],
      notes: "Notes must become the private context-to-work layer, not a generic notebook. Cycle 8 adds the restrained private-writing empty state and clarifies that raw notes stay out of collaborative surfaces.",
      nextActions: ["Define extract-level permissions.", "Build user-approved action extraction.", "Create decision log surface."],
    },
  ],
  ecosystemFlows: [
    {
  ...
  collaborationLoop: [
    ...
    },
    {
      ...
      nextAction: "Write the first four-product wedding demo script.",
  ...
  campaigns: [
    {
      ...
      status: "Selected",
      assetsNeeded: ["venue pitch email", "60 second demo", "feedback form"],
      startDate: "2026-05-13",
      endDate: "2026-06-30",
      currentBlocker: "Needs demo script, offer detail, and feedback form.",
      nextStep: "Write the 60 second demo script and first email variant.",
      progress: 28,
  ...
  decisions: [
    ...
    },
    {
      ...
      notes: "Use this as market-facing shorthand while keeping the product plain-language and anti-theatre. May 12 pass tightened the subhead to 'Built for the 80% who don't work in tech,' shortened the manifesto copy, sequenced the product dots, slowed the product reveal, and added a footer.",
    },
    {
