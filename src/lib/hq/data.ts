  ...
  pilots: [
    {
      ...
      name: "Founding Venue Programme — Venue Editions",
      offer: "Sponsored wedding planning workspaces, 12 months free per couple, co-branded eyebrow only. Per-couple redemption codes minted via `pnpm issue:codes`; redeemed at signalstudio.ie/redeem/[code]; auto-drop to Free at month 12.",
      targetParticipants: "Wedding venues and hotels with active wedding coordination.",
      value: "A branded planning workspace for couples and venue coordinators — venue keeps the gift register, couple keeps the workspace beyond the wedding.",
      ask: "Feedback from venue coordinator and participating couples; consent to use as a case study if useful.",
      successCriteria: [
        ...
        "Lamb's Hill soft launch — first couple redeems by 2026-05-27 (Cycle 8.5 day-14)",
  ...
  decisions: [
    {
      ...
      decision: "Ship the suite design-system v1 across all five Signal Studio repos in one paired sweep: one indigo, paper white on Studio/Tasks/Roadmap/Analytics, off-black ink at #111111, five wordmark gestures (broadcast / heartbeat / advance / tick / settle).",
      category: "Brand",
      date: "2026-05-13",
      reason: "The umbrella + four products were running drift-prone token sets — warm-cream paper on every surface, ink at #18181b, per-product wordmark gestures that had diverged from one another over time (Roadmap one-shot slide, Analytics static, Notes caret blink). The design canvas locked a single spec: one indigo across the house, white paper on suite-register products, off-black at #111111, and five canonical motions (broadcast 2.6s, heartbeat 1.6s, advance 2.6s, tick 2.4s, settle 3.2s). Five paired commits ensure no in-between state where the wordmarks talk past each other.",
      alternatives: "Roll out per-product over five weeks (drift between repos); apply tokens only and defer motion (visual seam between umbrella and products); freeze the warm cream on Tasks (breaks the suite-paper rule).",
      ...
      status: "Active",
      relatedObjects: ["Signal Studio", "Signal Tasks", "Signal Roadmap", "Signal Analytics", "Signal Notes", "/brand asset hub"],
      notes: "Shipped 2026-05-13. Five commits: Studio de1c02c (tokens + .brand-mark + /brand asset hub with 18 SVG downloads + email-sig text), Tasks 699b587 (tokens + heartbeat 1.6s), Roadmap dadb825 (tokens + advance 2.6s), Analytics dd1019d (tokens + new .analytics-dot tick 2.4s), Notes ddb4da1 (wordmark settle 3.2s — notebook surface untouched per locked aesthetic). Post-deploy audit caught /pricing rendering prior-cycle wordmark motions; fixed in 19d3166 (pricing-mark animations aligned + Brand nav prefetch=false to silence 18 preload warnings). /brand is live at signalstudio.ie/brand with downloadable SVGs (18 logos) and email signatures. Owed follow-up: page-by-page .studio-mark deprecation as surfaces get retouched.",
    },
    {
