...
export const seedHqData: HqData = {
  ...
  focus: {
    stage: "Pre-launch",
    weekOf: "2026-05-11",
    theme: "Cycle 5: connect the wedding proof path to conversion.",
    focus:
      "Give viewers of the wedding shared update a relevant Studio page, pilot CTA, and four-product explanation instead of a generic homepage.",
    priorities: [
      "Ship `/weddings` as the first wedge conversion route.",
      "Route wedding shared-update CTAs to `/weddings`.",
      "Use the page in the first venue outreach and demo story.",
    ],
    risks: [
      "Product work is ahead of distribution.",
      "The wedding page still needs a stronger offer section before broad outreach.",
      "The public artefact still needs view-to-creator attribution.",
    ],
    nextActions: [
      "Turn `/wedding-planning/update` into a short demo script.",
      "Add view-to-creator tracking once the share page is validated.",
      "Build the full wedding planning workspace template behind the `/weddings` route.",
    ],
  },
  products: [
    {
  ...
  templates: [
    {
      ...
      notes: "The conversion page exists; the full duplicable workspace still needs building.",
    },
    {
      id: "venue-checklist",
