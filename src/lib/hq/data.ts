...
export const seedHqData: HqData = {
  ...
  focus: {
    stage: "Pre-launch",
    weekOf: "2026-05-11",
    theme: "Cycle 6: make the wedding workspace repeatable.",
    focus:
      "Turn the weddings/events proof path into a reusable workspace template that creators can open, remix, and share.",
    priorities: [
      "Publish the wedding planning workspace template in Signal Tasks.",
      "Connect `/weddings` to the template as the first creator action.",
      "Use the template plus shared update as the first venue outreach proof.",
    ],
    risks: [
      "Product work is ahead of distribution.",
      "The template is Tasks-first until Notes, Roadmap, and Analytics are connected around the same scene.",
      "Template usage still needs source attribution from Studio and shared-update links.",
    ],
    nextActions: [
      "Write the 60-second demo script using the template and shared update.",
      "Add view-to-template and template-to-workspace source tracking.",
      "Build the Notes meeting follow-up and Analytics Today Signal examples for the same wedding workspace.",
    ],
  },
  products: [
    {
