...
export const seedHqData: HqData = {
  version: 1,
  updatedAt: "2026-05-12T00:45:00Z",
  focus: {
    stage: "Pre-launch",
    weekOf: "2026-05-11",
    theme: "Cycle 7: connect wedding context and attention.",
    focus:
      "Make the same wedding/events scene visible across Notes, Tasks, Roadmap, and Analytics.",
    priorities: [
      "Show the venue meeting follow-up in Signal Notes.",
      "Show the matching Today Signal in Signal Analytics.",
      "Use the four-product wedding scene as the first demo script spine.",
    ],
    risks: [
      ...
      "The homepage positioning test needs feedback before it becomes permanent brand doctrine.",
    ],
    nextActions: [
      "Write the 60-second demo script around Notes -> Tasks -> Roadmap -> Analytics.",
      "Add view-to-template and template-to-workspace source tracking.",
      "Turn the Notes follow-up and Analytics briefing into shareable links.",
    ],
  },
  products: [
    {
    ...
    },
    {
      ...
      notes: "Notes must become the context-to-work layer, not a generic notebook. Cycle 7 adds the venue meeting follow-up proof block.",
      nextActions: ["Build user-approved action extraction.", "Design note-to-work approval pattern.", "Create decision log surface."],
    },
  ],
  ecosystemFlows: [
    {
