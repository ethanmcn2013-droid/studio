...
export const MAKE_LABS: Lab[] = [
  ...
  },
  {
    ...
    category: "product",
    state: "PARKED",
    href: "/__design-lab/design",
    captureUrl: "/__design-lab/design",
    where: "studio · design lab",
    note: "The dot narrative, five gestures, print plates. Archived from the public estate 2026-09-08; renders on previews and local builds only.",
    hasThumb: true,
  },
  ...
  },
  {
    ...
    captureUrl: "/__design-lab/design",
    where: "studio · design lab",
    note: "The animated dot character: the WAAPI engine, the calibrated frames, and the five gestures. Archived with the design page 2026-09-08.",
    hasThumb: true,
    thumbSource: "external",
  },
  {
