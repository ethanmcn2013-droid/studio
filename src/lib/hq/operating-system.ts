...
export const HQ_HUBS: HqHub[] = [
  ...
  },
  {
    ...
    loop: "sell",
    label: "Waitlist",
    title: "Public access ledger",
    href: "/hq/waitlist",
    audience: ["founder", "operator", "marketing"],
    mode: "live",
    summary: "The live list from /waitlist, newest first, with source and use-case context.",
    primaryMetric: "staged access",
    secondaryMetric: "email capture",
    action: "review new names",
  },
  {
    key: "assets",
    loop: "make",
  ...
  },
  {
    ...
    loop: "make",
    label: "Copy Review",
    title: "Founder Copy Review",
    href: "/hq/copy-review",
    audience: ["founder", "operator", "marketing"],
    mode: "working",
    summary:
      "Version-aware copy approval for the site, products, internal rooms, pricing, empty states, and launch assets.",
    primaryMetric: "hash-bound approvals",
    secondaryMetric: "weekly review mode",
...
export const HQ_ASSETS: HqAsset[] = [
  ...
  },
  {
    ...
    source: "public/brand/collateral/explorations",
    action: "Choose the card",
    note: "Shortlist locked: Indigo and Numeral, founder-contact reverse, proof both on stock. Certificate and Seal archived.",
  },
  {
    id: "cafe-card-room",
    title: "The Café Card, chosen: Campaign",
    group: "brand",
    audience: ["founder"],
    state: "ready",
    owner: "Founder / Brand",
    ...
    source: "public/brand/collateral/explorations",
    action: "Choose the card",
    note: "Decision recorded: Campaign, the poster's line at counter scale. Alternates archived in the room.",
  },
  {
    id: "poster-room",
    title: "The Campaign Poster, chosen: Ink",
    group: "brand",
    audience: ["founder"],
    state: "ready",
    owner: "Founder / Brand",
    href: "/hq/poster",
    source: "public/brand/collateral/explorations",
    action: "Choose per wall",
    note: "Decision recorded: Ink, the deck's poster. Alternate grounds archived in the room.",
  },
  {
    id: "card-batch-two",
