...
export const HQ_ASSETS: HqAsset[] = [
  {
    ...
    title: "The Partner Card — four directions",
    group: "brand",
    audience: ["founder"],
    state: "needs-review",
    owner: "Founder / Brand",
    ...
    note: "Indigo, Certificate, Numeral, Seal — the object presented at signing, numbered by hand, never reprinted.",
  },
  {
    id: "cafe-card-room",
    title: "The Café Card — four directions",
    group: "brand",
    audience: ["founder"],
    state: "needs-review",
    owner: "Founder / Brand",
    ...
    source: "public/brand/collateral/explorations",
    action: "Choose the card",
    note: "Ink, Campaign, Belief, Indigo — the permission-placed A6. Different counters want different grounds; two can run at once.",
  },
  {
    id: "poster-room",
    title: "The Campaign Poster — four directions",
    group: "brand",
    audience: ["founder"],
    state: "needs-review",
    owner: "Founder / Brand",
    ...
    note: "Ink, Indigo, Paper, The Dot — A2, one campaign line, chosen per placement. Posters are placements, not editions.",
  },
  {
    id: "card-batch-two",
