      ...
      <div className="floor">
          <section className="product wide" aria-labelledby="time-h">
            <div className="inner">
              ...
              <figure className="app ui rise" id="time-app" aria-label="Timeline demo. Mara and Finn’s dates turn across and down, followed by an illustrative activity preview of who has caught up.">
                <div className="rail" aria-hidden="true">
                  <span className="dotmark"></span><span className="sep"></span>
                  <span className="it"><svg viewBox="0 0 24 24"><path d="M6 4h9l4 4v12H6z"/><path d="M9 12h6M9 16h6"/></svg>Notes</span>
                  <span className="it"><svg viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="3"/><path d="m8.5 12 2.5 2.5 4.5-5"/></svg>Tasks</span>
                      ...
                      <div className="tl-activity-fold" id="tlactivity" aria-hidden="true" inert><div className="tl-fold-inner">
                        <div className="tl-activity">
                          <div className="tl-activity-copy">
                            ...
                            <h3>Ciara has caught up.</h3>
                            <p>Rory, Aoife and Daniel too. Anyone with the link can read the dates. These are the people who have.</p>
                          </div>
                          <div className="tl-viewer-panel">
                            <div className="tl-viewer-heading"><h4>People who caught up</h4><span>Example viewers</span></div>
                            <ul>
                              <li><i aria-hidden="true">CO</i><span><b>Ciara O’Brien</b><small>Family</small></span><span className="tl-viewed">This morning</span></li>
                              <li><i aria-hidden="true">RK</i><span><b>Rory Kelly</b><small>Guest</small></span><span className="tl-viewed">Yesterday</span></li>
                              <li><i aria-hidden="true">AM</i><span><b>Aoife Murphy</b><small>Florist</small></span><span className="tl-viewed">Yesterday</span></li>
                              <li><i aria-hidden="true">DW</i><span><b>Daniel Walsh</b><small>Photographer</small></span><span className="tl-viewed">Monday</span></li>
                            </ul>
