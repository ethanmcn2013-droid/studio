/** Direction A · the closing sheet: who it is for, and the way in.
 *
 * Two doors until 2026-09-11. The second went to /venues, which is archived
 * until the founding-venue campaign runs — so the waitlist is the only door
 * now, and the venue argument stays where it already was, in the prose. */
