 ...
 * analytics property. CSP hosts are allow-listed in next.config.ts.
 *
 * Note: this is the raw gtag with no consent gate. If a cookie-consent banner
 * is added later, switch to Consent Mode v2 (default `denied`) here.
 */
