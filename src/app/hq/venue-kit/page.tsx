...
const DIRECTIONS: ReviewDirection[] = [
  {
    ...
    images: [{ src: `${P}/venue-deck-preview.png`, alt: "All ten slides of the venue pitch deck", caption: "Cover → the 19,898 problem → four views → the couple → the team → the demo → €1,500 → the Founding 25 → the standard → the pilot ask." }],
  ...
  },
  {
    ...
    images: [{ src: `${P}/permission-form-preview.png`, alt: "Founding venue permission form", caption: "Five tick-lines, name, logo, quote, press, case study, each standing alone, each withdrawable by one email." }],
    read: "The legal floor of the proof system: until a venue signs this, the S·4 post, the founding venue card, and every named mention stay specimens. Designed to be signed without hesitation.",
    links: [
