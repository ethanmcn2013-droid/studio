...
const ROOMS: Room[] = [
  { href: "/hq/product-hero-design-motion", name: "The Product Hero Room", state: "IN PROGRESS", note: "The four product hero motion graphics, redesigned to the Signal Hero Playbook. Notes and Timeline preferred pairs chosen; Tasks rebuilding to world-class. Every direction, its home, and how to run it." },
