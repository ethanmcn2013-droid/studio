...
export const TEMPLATES: AnyTemplateDef[] = [
  ...
  def({
    ...
    subject: (d) => `Signal Studio for ${d.venueName} couples`,
    preheader: () => "Private notes, tasks and a wedding timeline for your booked couples.",
    assumptions: [
      "The venue film is not yet produced; the poster is a composed frame from the locked brief.",
      "This held specimen states the current annual terms. The selected January draft and both founder decisions are required before a send on or after 21 January 2027.",
