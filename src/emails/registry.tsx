 ...
 * (docs/email-system/sender-architecture.md). The six receiving aliases are
 * verified; sender changes still require evidence from the actual provider.
 */
...
export const TEMPLATES: AnyTemplateDef[] = [
  def({
    ...
    priority: "P0",
    sender: { name: "Signal Studio", address: CONTACT_EMAILS.general, proposed: false },
    replyTo: CONTACT_EMAILS.support,
    ...
    assumptions: [
      ...
      "The current provider sender is retained; support@ is the verified reply route.",
    ],
  ...
  def({
    ...
    classification: "transactional",
    priority: "P0",
    sender: { name: "Signal Studio", address: CONTACT_EMAILS.billing, proposed: true },
    replyTo: CONTACT_EMAILS.billing,
    unsubscribe: "Not applicable · transactional",
    tracking: "No open tracking, no click tracking",
  ...
  def({
    ...
    priority: "P0",
    sender: { name: "Signal Studio", address: CONTACT_EMAILS.general, proposed: false },
    replyTo: CONTACT_EMAILS.privacy,
    unsubscribe: "Not applicable · transactional",
    tracking: "No open tracking, no click tracking",
  ...
  def({
    ...
    priority: "P0",
    sender: { name: "Ethan McNamara", address: CONTACT_EMAILS.general, proposed: false },
    replyTo: CONTACT_EMAILS.partnerships,
  ...
  def({
    ...
    priority: "P1",
    sender: { name: "Signal Studio", address: CONTACT_EMAILS.general, proposed: false },
    replyTo: CONTACT_EMAILS.general,
    ...
    assumptions: [
      ...
      "The Dispatch keeps the current company sender unless provider separation is approved later.",
    ],
  ...
  def({
    ...
    priority: "P1",
    sender: { name: "Signal Studio", address: CONTACT_EMAILS.general, proposed: false },
    replyTo: CONTACT_EMAILS.security,
