 ...
 *   letter (Letterhead) the design element: name at 19px, role and the
 *                       direct address grouped tight beneath it. When
 *                       this block is present, the postal line outside
 *                       the sheet drops its duplicate address.
 *
  ...
  if (d.signature === "letter") {
    return (
      <Section style={{ margin: `${d.space.section}px 0 0` }}>
        <Text
          className="em-soft"
          style={{ ...d.body, color: INK_SOFT, margin: "0 0 14px" }}
        >
          {closing}
        </Text>
        <Text
        ...
        <Text
          className="em-soft"
          style={{ fontSize: 13, lineHeight: "20px", color: INK_SOFT, margin: 0 }}
        >
          {role}
        </Text>
