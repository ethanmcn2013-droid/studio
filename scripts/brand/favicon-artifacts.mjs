...
const { BROWSER_ICON_BACKGROUND } = require("../../src/lib/brand/browser-icons.ts");
...
export async function renderFaviconFrame(canvas) {
  const response = new ImageResponse(createElement(SuiteMark, { canvas, background: BROWSER_ICON_BACKGROUND }), {
    width: canvas,
    height: canvas,
  });
